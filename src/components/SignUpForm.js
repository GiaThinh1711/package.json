                ...
                <Grid container justify='center' alignContent='center'>
                    <Grid item xs={6} md={4}>
                        <Paper elevation={4} style={{ padding: '20px 15px', marginTop: '30px' }}>
                            ...
                            <FormControl fullWidth margin='normal' margin='normal' error={this.props.touched.username && !!this.props.errors.username}>
                            ...
                            <FormControl fullWidth margin='normal' error={this.props.touched.email && !!this.props.errors.email}>
